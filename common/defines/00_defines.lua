...
NGame = {
	...
	HANDS_OFF_START_TAG = "HEJ",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
},

NDiplomacy = {
	DIPLOMACY_REQUEST_EXPIRY_DAYS = 30,
	BASE_SURRENDER_LEVEL = 1.0,						-- Surrender when level reached. valid 0-1
	MAX_TRUST_VALUE = 150,							-- Max trust value cap.
	MIN_TRUST_VALUE = -150,							-- Min trust value cap.
	MAX_OPINION_VALUE = 250,						-- Max opinion value cap.
	MIN_OPINION_VALUE = -250,						-- Min opinion value cap.
